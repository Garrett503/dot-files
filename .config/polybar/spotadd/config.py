CLIENT_ID="#" #Get from spotify dev website
CLIENT_SECRET="#" #Get from spotify dev website
...
#PLAYLIST_ID="5rvQibveyj1RVK5Jq6bp8x" #Get from playlist options > Share > Copy Spotify URI & remove "spotify:playlist:"
