...
|bitwarden-bin                |  174.28 MiB |  A secure and free password manager for all of your devices.|
|cava                         |  0.07 MiB   |  Console-based Audio Visualizer for Alsa|
|cmatrix                      |  0.09 MiB   |  A curses-based scrolling 'Matrix'-like screen|
|cointop                      |  11.43 MiB  |  An interactive terminal based UI application for tracking cryptocurrencies|
...
|firefox                      |  221.56 MiB |  Standalone web browser from mozilla.org|
|firefox-developer-edition    |  216.55 MiB |  Developer Edition of the popular Firefox web browser|
|firefox-nightly              |  221.12 MiB |  Standalone Web Browser from Mozilla — Nightly build (en-US)|
|flameshot                    |  1.14 MiB   |  Powerful yet simple to use screenshot software|
|font-manager                 |  9.40 MiB   |  A simple font management application for GTK+ Desktop Environments|
...
|google-chrome                |  226.90 MiB |  The popular and trusted web browser by Google (Stable Channel)|
|google-chrome-dev            |  233.28 MiB |  The popular and trusted web browser by Google (Dev Channel)|
|gpick                        |  0.98 MiB   |  Advanced color picker written in C++ using GTK+ toolkit|
|grub                         |  32.91 MiB  |  GNU GRand Unified Bootloader (2)|
...
|kate                         |  20.91 MiB  |  Advanced Text Editor|
|kitty                        |  12.97 MiB  |  A modern, hackable, featureful, OpenGL-based terminal emulator|
|konsole                      |  5.58 MiB   |  KDE's terminal emulator|
|ksysguard                    |  3.35 MiB   |  Track and control the processes running in your system|
|liquidctl                    |  0.53 MiB   |  Cross-platform CLI and Python drivers for AIO liquid coolers and other devices|
|lsd                          |  1.03 MiB   |  Modern ls with a lot of pretty colors and awesome icons|
|lxappearance                 |  0.39 MiB   |  Feature-rich GTK+ theme switcher of the LXDE Desktop|
...
|nano                         |  2.26 MiB   |  Pico editor clone with enhancements|
...
|nvidia                       |  18.16 MiB  |  NVIDIA drivers for linux|
|nvidia-settings              |  1.57 MiB   |  Tool for configuring the NVIDIA graphics driver|
|nvidia-utils                 |  308.71 MiB |  NVIDIA drivers utilities|
|obs-studio                   |  14.47 MiB  |  Free, open source software for live streaming and recording|
...
|php                          |  23.11 MiB  |  A general-purpose scripting language that is especially suited to web development|
|php-apache                   |  12.43 MiB  |  Apache SAPI for PHP|
|phpmyadmin                   |  43.63 MiB  |  PHP and hence web-based tool to administrate MySQL over the WWW|
|phpstorm                     |  730.87 MiB |  Lightweight and Smart PHP IDE|
...
|pulseaudio                   |  6.06 MiB   |  A featureful, general-purpose sound server|
|pulseaudio-alsa              |  0.00 MiB   |  ALSA Configuration for PulseAudio|
|pulseaudio-jack              |  0.07 MiB   |  Jack support for PulseAudio|
|python-pip                   |  1.56 MiB   |  The PyPA recommended tool for installing Python packages|
|python-pywal                 |  0.26 MiB   |  Generate and change colorschemes on the fly|
|qalculate-gtk                |  5.36 MiB   |  GTK frontend for libqalculate|
|qbittorrent                  |  8.22 MiB   |  An advanced BitTorrent client programmed in C++, based on Qt toolkit and libtorrent-rasterbar.|
|qt5ct                        |  0.78 MiB   |  Qt5 Configuration Utility|
|ranger                       |  1.82 MiB   |  Simple, vim-like file manager|
|reflector                    |  0.09 MiB   |  A Python 3 module and script to retrieve and filter the latest Pacman mirror list.|
...
|skypeforlinux-preview-bin    |  279.27 MiB |  Skype for Linux - Preview/Insider Version|
...
|thunar                       |  6.36 MiB   |  Modern file manager for Xfce|
...
|ttf-iosevka                  |  84.26 MiB  |  Typeface family designed for coding, terminal use and technical documents.|
...
|vim                          |  3.75 MiB   |  Vi Improved, a highly configurable, improved version of the vi text editor|
...
|vlc                          |  57.87 MiB  |  Multi-platform MPEG, VCD/DVD, and DivX player|
|wget                         |  2.88 MiB   |  Network utility to retrieve files from the Web|
|wpa_supplicant               |  5.55 MiB   |  A utility providing key negotiation for WPA wireless networks|
...
|youtube-dl                   |  12.89 MiB  |  A command-line program to download videos from YouTube.com and a few more sites|
